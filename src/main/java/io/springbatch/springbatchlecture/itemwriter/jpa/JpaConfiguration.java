...
import io.springbatch.springbatchlecture.itemwriter.xml.Customer;
import io.springbatch.springbatchlecture.itemwriter.xml.CustomerRowMapper;
...
public class JpaConfiguration {
    ...
    private ItemProcessor<? super Customer, ? extends Customer2> customeItemProcessor() {
        return new CustomeItemProcessor();

    }

    private ItemWriter<? super Customer2> customItemWriter() {
